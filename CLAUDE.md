...
Claude generates plans, app executes, logs sync back for analysis.
...
- Server: 7 suites, 99 tests (`test_base_validator`, `test_strength_validator`,
  `test_cycling_validator`, `test_catalog_seed`, `test_strength_warnings`,
  `test_catalog_validation`, `test_analytics_helpers`)
